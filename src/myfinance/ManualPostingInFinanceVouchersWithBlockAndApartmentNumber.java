...
public class ManualPostingInFinanceVouchersWithBlockAndApartmentNumber extends TestBase {
	...
	public void ManualpostingWarning(String amount) throws InterruptedException {
		...
		helper1.SAP();
		driver.findElement(By.xpath(FinanceVariables.SelectBlock)).clear();
		helper1.SAP();
		driver.findElement(By.xpath(FinanceVariables.SelectBlock)).sendKeys(FinanceGlobalVariables.OwnerBlock);
		helper1.SAP();
		driver.findElement(By.xpath(FinanceVariables.SelectBlock)).sendKeys(Keys.ENTER);
		helper1.SAP();
		...
		alert2.accept();
		helper1.SAP();
		driver.findElement(By.id(FinanceVariables.SelectApartment)).clear();
		helper1.SAP();
		driver.findElement(By.id(FinanceVariables.SelectApartment)).sendKeys(FinanceGlobalVariables.OwnerApartmentNo);
		helper1.SAP();
		...
		action.moveToElement(driver.findElement(By.xpath(FinanceVariables.VoucherNumberTabInFinanceVouchers))).doubleClick().build().perform();
	helper1.SAP();
		...
		driver.findElement(By.xpath(FinanceVariables.DebitPath)).clear();
		helper1.SAP();
		driver.findElement(By.xpath(FinanceVariables.DebitPath)).sendKeys("55.00");
		helper1.SAP();
		driver.findElement(By.xpath(FinanceVariables.Credit)).sendKeys(Keys.BACK_SPACE);
		helper1.SAP();
		driver.findElement(By.xpath(FinanceVariables.Credit)).sendKeys(Keys.BACK_SPACE);
		helper1.SAP();
		driver.findElement(By.xpath(FinanceVariables.Credit)).sendKeys(Keys.BACK_SPACE);
		...
		driver.findElement(By.xpath(FinanceVariables.Credit)).sendKeys(Keys.BACK_SPACE);
		helper1.SAP();
		driver.findElement(By.xpath(FinanceVariables.Credit)).sendKeys("55.00");
		helper1.SAP();
		driver.findElement(By.xpath(FinanceVariables.GLDescriptionPath)).click();
		helper1.SAP();
		driver.findElement(By.xpath(FinanceVariables.SaveVoucher)).click();
...
/*WebElement Vouchertable=driver.findElement(By.xpath(FinanceVariables.WaiveOffTable));
