...
public class SimulationOftenantFacilityWithAdminLogin extends TestBase{
	@Test(priority=1,dataProvider="TenantFacilitySimulationWithAdminLogin",dataProviderClass= DataProvider5.class)
	...
	Reporter.log("ScriptName:Simulate with Admin Login - Book for 30 min (10:01 AM to 10:30 AM) - Charge should be 2000", true);	
	Reporter.log("----------------------------------------------------------------------------", true);
	Reporter.log(" ", true);
	...
	helper.TakeScreenShot("Search For TenantFacility Allow For Booking");}
	try{
	...
	helper.TakeScreenShot("Simulation Of TenantFacility with Specified Timings With Admin Login");
	helper.DeepSleep();
	...
	Reporter.log("---------------------------", true);	
	Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"Search For TenantFacility Allow For Booking" , true);
	Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"Simulation Of TenantFacility with Specified Timings With Admin Login",true);
	Reporter.log(" ", true);
