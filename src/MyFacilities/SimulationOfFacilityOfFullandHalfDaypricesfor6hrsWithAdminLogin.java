...
public class SimulationOfFacilityOfFullandHalfDaypricesfor6hrsWithAdminLogin extends TestBase{
	@Test(priority=1,dataProvider="SimulateFacilityWithHalfAndFullDayPricesfor6hoursWithAdminLogin",dataProviderClass= DataProvider7.class)
	...
	Reporter.log("ScriptName:Admin Login  - Book for 6 hours  (9 AM to 3 PM) - Should show Rs. 100x6 = 600", true);	
	Reporter.log("----------------------------------------------------------------------------", true);
	Reporter.log(" ", true);
	...
	helper.TakeScreenShot("Simulation Of Facility With half And Full day Prices For 6hrs With Admin Login");
	helper.DeepSleep();
	}}			
	...
	Reporter.log("---------------------------", true);	
	Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"Simulation Of Facility With half And Full day Prices For 6hrs With Admin Login",true);
	Reporter.log(" ", true);
