...
public class BookTenantFacilityWithOverlapTimingWithAdminLogin extends TestBase{
@Test(priority=1,dataProvider="TenatFacilityOverlapWithAdminLogin",dataProviderClass= DataProvider5.class)
...
Reporter.log("ScriptName:Admin Login - Book for 10:00 AM to 12:00 PM - Same timing Overlap", true);	
Reporter.log("----------------------------------------------------------------------------", true);
Reporter.log(" ", true);
		...
		helper.MaxSleep();
		helper.TakeScreenShotOfWindowPopUp("Popup Came After saving details of Booking of TenatFacility with Alreadybooked Timing With Admin Login");
		helper.DeepSleep();
		try{
		helper.ProcessAlert();
		helper.Sleep();
		...
		Reporter.log("---------------------------", true);	
		Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"Popup Came After saving details of Booking of TenatFacility with Alreadybooked Timing With Admin Login",true);
		Reporter.log(" ", true);
