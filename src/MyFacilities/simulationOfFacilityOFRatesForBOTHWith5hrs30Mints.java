...
public class simulationOfFacilityOFRatesForBOTHWith5hrs30Mints extends TestBase{
	@Test(priority=1,dataProvider="SimulateFacilityWithSpecialPackageAndHourlyRatesWithAdminLoginFor5:30hrs",dataProviderClass= DataProvider6.class)
	...
	Reporter.log("ScriptName:Simulate Facilityof RatesForBOTH Admin Login  - Book for 5:30 hours (9 AM to 2:30 PM) - Should show Rs.5000 + 1500 = 6500 (Spl Package + hourly rate)", true);	
	Reporter.log("----------------------------------------------------------------------------", true);
	Reporter.log(" ", true);
	...
	helper.DeepSleep();
		...
		helper.TakeScreenShot("Simulation Of BOTH Facility For 5Hrs 30Mints With Admin Login");
		helper.DeepSleep();
		}}
		...
		Reporter.log("---------------------------", true);
		Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"Simulation Of BOTH Facility For 5Hrs 30Mints With Admin Login" , true);
		Reporter.log(" ", true);
			}	
