...
public class CreateFacilityWithHourlyhalfDayFullDayPriceDetails extends TestBase{
@Test(priority=1,dataProvider="FacilityWithHalfAndFullDayPrices",dataProviderClass= DataProvider4.class)
public void AddFacility(String EnterFacilityName,String EnterContactPersonName,String EnterContactNumber,String RatesFor,String FromTime,String ToTime,String EnterMinimumHours,String EnterAmountForMinimumHours,String EnterMinimumHoursOfHalfDay,String EnterAmountForMinimumHoursOfHalfDay,String EnterMinimumHoursOfFullDay,String EnterAmountForMinimumHoursOfFullDay,String EnterFacilityNameToSearch,String AddedFacilityName) throws InterruptedException, IOException{
Reporter.log("Script Name:Admin---->Application--->MyFacilities--->Create one facility with PAID - Allowed for Booking - Hourly Rs. 100, 1/2 Day - Rs. 500, Full Day - Rs. 1000", true);	
Reporter.log("----------------------------------------------", true);	
Reporter.log(" ", true);
...
helper.DeepSleep();
Method6.AddFacilityWithHourlyhalfDayFullDayPriceDetails(EnterFacilityName, EnterContactPersonName, EnterContactNumber, RatesFor, FromTime, ToTime, EnterMinimumHours, EnterAmountForMinimumHours, EnterMinimumHoursOfHalfDay, EnterAmountForMinimumHoursOfHalfDay, EnterMinimumHoursOfFullDay, EnterAmountForMinimumHoursOfFullDay, EnterFacilityNameToSearch, AddedFacilityName);
}
@Test(priority=2,dataProvider="EditFacilityWithHalfAndFullDayPrices",dataProviderClass= DataProvider4.class)
...
helper.TakeScreenShot("EditFacilityWithHourlyhalfDayFullDayPriceDetails");
...
helper.TakeScreenShot("DeletedFacilityWithHourlyhalfDayFullDayPriceDetails");
	}		}
else{
...
@Test(priority=3,dataProvider="FacilityWithHalfAndFullDayPrices",dataProviderClass= DataProvider4.class)
public void AddFacilityAfterDelete(String EnterFacilityName,String EnterContactPersonName,String EnterContactNumber,String RatesFor,String FromTime,String ToTime,String EnterMinimumHours,String EnterAmountForMinimumHours,String EnterMinimumHoursOfHalfDay,String EnterAmountForMinimumHoursOfHalfDay,String EnterMinimumHoursOfFullDay,String EnterAmountForMinimumHoursOfFullDay,String EnterFacilityNameToSearch,String AddedFacilityName) throws InterruptedException, IOException{
helper.ClickByID(VariableCalling.ClickOnAddButton);
helper.DeepSleep();
Method6.AddFacilityWithHourlyhalfDayFullDayPriceDetails(EnterFacilityName, EnterContactPersonName, EnterContactNumber, RatesFor, FromTime, ToTime, EnterMinimumHours, EnterAmountForMinimumHours, EnterMinimumHoursOfHalfDay, EnterAmountForMinimumHoursOfHalfDay, EnterMinimumHoursOfFullDay, EnterAmountForMinimumHoursOfFullDay, EnterFacilityNameToSearch, AddedFacilityName);
Reporter.log(" ", true);
...
Reporter.log("---------------------------", true);	
Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"PaidFacilityWithHourly,HalfDayAndFulldayPrices" , true);
Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"EditFacilityWithHourlyhalfDayFullDayPriceDetails" , true);
Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"DeletedFacilityWithHourlyhalfDayFullDayPriceDetails" , true);
	}
