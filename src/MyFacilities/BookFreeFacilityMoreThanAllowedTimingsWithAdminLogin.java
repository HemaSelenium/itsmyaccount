...
public class BookFreeFacilityMoreThanAllowedTimingsWithAdminLogin extends TestBase{
	...
	Reporter.log("ScriptName:Admin Login --> Book for 40 min (Eg: 9:31 AM to 10:11 AM) - More than allowed time", true);	
	Reporter.log("----------------------------------------------------------------------------", true);
	Reporter.log(" ", true);
	...
	try{
		...
		helper.TakeScreenShotOfWindowPopUp("Booking Is Not allowed of Free Facility with MoreThan Allowed Time");
		Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"Booking Is Not allowed of Free Facility with MoreThan Allowed Time", true);
	...
	Reporter.log("---------------------------", true);	
	Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"Search For Free Facility To Book MoreThan Allowed Time" , true);
	Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"Booking Free Facility with MoreThan Allowed Timings", true);
	Reporter.log(" ", true);
