...
public class BookingOwnerFacilityWithMemberLogin extends TestBase{
@Test(priority=1,dataProvider="OwnerFacilityBookingWithOwnerLogin",dataProviderClass= DataProvider5.class)
...
Reporter.log("ScriptName:Member Login (Owner) - Book for 1 hours (9:00 to 10:00 AM) - Charge should be 1000", true);	
Reporter.log("----------------------------------------------------------------------------", true);
Reporter.log(" ", true);
...
helper.MaxSleep();
helper.TakeScreenShotOfWindowPopUp("PopupCameAfter saving details of Booking of OwnerFacility with Specified Timings With MemberLogin");
helper.MaxSleep();
try{
helper.ProcessAlert();
helper.Sleep();
...
Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"PopupCameAfter saving details of Booking of OwnerFacility with Specified Timings With MemberLogin",true);
Reporter.log(" ", true);
