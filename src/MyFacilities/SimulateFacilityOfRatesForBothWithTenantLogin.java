...
public class SimulateFacilityOfRatesForBothWithTenantLogin extends TestBase{
	@Test(priority=1,dataProvider="SimulateRatesForBOTHFacilityWithTenantLogin",dataProviderClass= DataProvider6.class)
	...
	Reporter.log("ScriptName:Simulate Facilityof RatesForBOTH Member Login (Tenant) - Book for 4 hours (9 AM to 1 PM) - Should show Rs. 1500x4 = 6000", true);	
	Reporter.log("----------------------------------------------------------------------------", true);
	Reporter.log(" ", true);
	...
	helper.TakeScreenShot("Simulation Of BOTH Facility with Specified Timings With Tenant Login");
	helper.DeepSleep();
	}		}
	...
	Reporter.log("---------------------------", true);
	Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"Simulation Of BOTH Facility with Specified Timings With Tenant Login" , true);
	Reporter.log(" ", true);
		}	
