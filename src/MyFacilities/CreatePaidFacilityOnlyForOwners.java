...
public void AddFacility(String EnterFacilityName,String EnterContactPersonName,String EnterContactNumber,String RatesFor,String FromTime,String ToTime,String EnterMinimumHours,String EnterAmountForMinimumHours,String EnterCancelCharges,String EnterFacilityNameToSearch,String AddedFacilityName) throws InterruptedException, IOException {
Reporter.log("Script Name:Admin---->Application--->MyFacilities--->Create one facility with PAID - Allowed for Booking - 1 hour Rs 1000 (Only for Owners) + Cancellation Charges of Rs. 250", true);	
Reporter.log("----------------------------------------------", true);	
Reporter.log(" ", true);
...
helper.MaxSleep();
Method5.AddFacilityForOwners(EnterFacilityName, EnterContactPersonName, EnterContactNumber, RatesFor, FromTime, ToTime, EnterMinimumHours, EnterAmountForMinimumHours, EnterCancelCharges, EnterFacilityNameToSearch, AddedFacilityName);
}
...
public void AddFacilityAfterDelete(String EnterFacilityName,String EnterContactPersonName,String EnterContactNumber,String RatesFor,String FromTime,String ToTime,String EnterMinimumHours,String EnterAmountForMinimumHours,String EnterCancelCharges,String EnterFacilityNameToSearch,String AddedFacilityName) throws InterruptedException, IOException {
	helper.ClickByID(VariableCalling.ClickOnAddButton);
	helper.DeepSleep();
	Method5.AddFacilityForOwners(EnterFacilityName, EnterContactPersonName, EnterContactNumber, RatesFor, FromTime, ToTime, EnterMinimumHours, EnterAmountForMinimumHours, EnterCancelCharges, EnterFacilityNameToSearch, AddedFacilityName);	
	Reporter.log(" ", true);
	...
	Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"EditPaidFacilityOnlyForOwners" , true);
	Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"DeletedPaidFacilityOnlyForOwners",true);
}
