...
public class BookingTenantFacilityWithOverlapTimingsWithTenantLogin extends TestBase{
@Test(priority=1,dataProvider="TenantFacilityOverlapWithTenantLogin",dataProviderClass= DataProvider5.class)
...
Reporter.log("ScriptName:Member Login (Tenant) - Book for 10:11 AM to 1:31 PM - Diff Timing but overlap", true);	
Reporter.log("----------------------------------------------------------------------------", true);
Reporter.log(" ", true);
...
helper.MaxSleep();
helper.TakeScreenShotOfWindowPopUp("Popup Came After saving details of Booking of TenantFacility with Alreadybooked Timing With Tenant Login");
helper.DeepSleep();
try{
helper.ProcessAlert();
helper.Sleep();
...
Reporter.log("---------------------------", true);	
Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"Popup Came After saving details of Booking of TenantFacility with Alreadybooked Timing With Tenant Login",true);
Reporter.log(" ", true);
}}
