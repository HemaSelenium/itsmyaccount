...
public class simulationOfFacilityWithPackagePricesWithTenantLogin extends TestBase{
	@Test(priority=1,dataProvider="SimulateFacilityWithPackagePricesWithTenantLogin",dataProviderClass= DataProvider7.class)
	...
	helper.TakeScreenShot("Simulation Of Facility With package Prices For 12hrs With Tenant Login");
	...
	Reporter.log("---------------------------", true);	
	Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"Simulation Of Facility With package Prices For 12hrs With Tenant Login",true);
	Reporter.log(" ", true);
		}
