...
public class SimulationOfFacilityWithHalfAndFullDaypricesfor1dayWithAdminLogin extends TestBase{
	@Test(priority=1,dataProvider="SimulateFacilityWithHalfAndFullDayPricesfor1dayWithAdminLogin",dataProviderClass= DataProvider7.class)
	...
	Reporter.log("ScriptName:Admin Login  - Book for 1 day  (9 AM to Next day 9 AM) - Should show Rs. 1000", true);	
	Reporter.log("----------------------------------------------------------------------------", true);
	Reporter.log(" ", true);
	...
	helper.DeepSleep();
	SeleniumHelper.driver.findElement(By.xpath(VariableCalling.EnterToDate)).sendKeys(MethodsCalling.EnterDayAfterTomorrowDate());
	...
	helper.TakeScreenShot("Simulation Of Facility With half And Full day Prices For 1Day With Admin Login");
	helper.DeepSleep();
	}}			
	...
	String PriceDetailsButton=FacilityColoumns.get(12).findElement(By.tagName("a")).getText();
	Reporter.log("Preice Details Button Is Exists With Name Of:" +PriceDetailsButton, true);
	helper.TakeScreenShot("Booking Not Allowed For Facility With half And Full day Prices For 1day With Admin Login");
	Reporter.log("Booking Not Allowed For Facility With half And Full day Prices For 1day With Admin Login", true);
	}}catch(NoSuchElementException Exception){
	...
	Reporter.log("---------------------------", true);	
	Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"Simulation Of Facility With half And Full day Prices For 1Day With Admin Login",true);
	Reporter.log(" ", true);
