...
public class BookingOTHFacilityWithDiffOverlapTimings extends TestBase{
	@Test(priority=1,dataProvider="OTHFacilitySimulationOfDifferentTimingOverLapWithAdminLogin",dataProviderClass= DataProvider6.class)
	...
	Reporter.log("ScriptName:Admin Login - Book for 12:01 AM to 3:00 PM - Diff Timing but overlap", true);	
	Reporter.log("----------------------------------------------------------------------------", true);
	Reporter.log(" ", true);
			...
			helper.MaxSleep();
			helper.TakeScreenShotOfWindowPopUp("Popup Came After Booking OTHFacility of Different Timing OverLap  with  Admin Login");
			helper.DeepSleep();
			try{
			helper.ProcessAlert();
			helper.Sleep();
			...
			Reporter.log("---------------------------", true);	
			Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"Popup Came After Booking OTHFacility of Different Timing OverLap  with  Admin Login",true);
			Reporter.log(" ", true);
