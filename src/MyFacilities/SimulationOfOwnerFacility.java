...
public class SimulationOfOwnerFacility extends TestBase{
	@Test(priority=1,dataProvider="OwnerFacilitySimulationWithAdminLogin",dataProviderClass= DataProvider5.class)
	...
	Reporter.log("ScriptName:Simulate with Admin Login - Book for 30 min (9:00 AM to 9:30 AM) - Charge should be 1000", true);	
	Reporter.log("----------------------------------------------------------------------------", true);
	Reporter.log(" ", true);
	...
	helper.TakeScreenShot("Search For OwnerFacility Allow For Booking");}
	try{
	...
	helper.TakeScreenShot("Simulation Of OwnerFacility with Specified Timings With Admin Login");
	helper.DeepSleep();
	...
	Reporter.log("---------------------------", true);	
	Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"Search For OwnerFacility Allow For Booking" , true);
	Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"Simulation Of OwnerFacility with Specified Timings With Admin Login",true);
	Reporter.log(" ", true);
