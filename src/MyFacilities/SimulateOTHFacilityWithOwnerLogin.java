...
public class SimulateOTHFacilityWithOwnerLogin extends TestBase{
	@Test(priority=1,dataProvider="OTHFacilitySimulationWithOwnerLogin",dataProviderClass= DataProvider6.class)
	...
	Reporter.log("ScriptName:Simulate OTH Facility with Member Login (Owner)", true);	
	Reporter.log("----------------------------------------------------------------------------", true);
	Reporter.log(" ", true);
	...
	helper.MaxSleep();
	helper.TakeScreenShotOfWindowPopUp("Booking OTHFacility With Owner Login");
	helper.DeepSleep();
	...
	Reporter.log("---------------------------", true);	
	Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"Booking OTHFacility With Owner Login" , true);
	Reporter.log(" ", true);
