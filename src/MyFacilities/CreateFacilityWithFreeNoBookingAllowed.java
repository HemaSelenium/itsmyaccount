...
public class CreateFacilityWithFreeNoBookingAllowed extends TestBase{
@Test(priority=1,dataProvider="AddFacilityNoAllowedBooking",dataProviderClass= DataProvider4.class)
public void AddFacility(String EnterFacilityName,String EnterContactPersonName,String EnterContactNumber,String RatesFor,String FromTime,String ToTime,String EnterFacilityNameToSearch,String AddedFacilityName) throws InterruptedException, IOException{
Reporter.log("Script Name:Admin---->Application--->MyFacilities--->Create one Facility With FREE - No booking allowed", true);	
Reporter.log("----------------------------------------------", true);	
Reporter.log(" ", true);
...
helper.DeepSleep();
Method5.AddFreeFacility(EnterFacilityName, EnterContactPersonName, EnterContactNumber, RatesFor, FromTime, ToTime, EnterFacilityNameToSearch, AddedFacilityName);
}
@Test(priority=2,dataProvider="EditFacilityNoAllowedBooking",dataProviderClass= DataProvider4.class)
...
try{
	...
	helper.TakeScreenShot("EditFacilityNoAllowedBooking");
	...
	try{
		...
		helper.TakeScreenShot("DeletedPaidFacilityWithNoAllowedBooking");
	}
...
@Test(priority=3,dataProvider="AddFacilityNoAllowedBooking",dataProviderClass= DataProvider4.class)
public void AddFacilityAfterDelete(String EnterFacilityName,String EnterContactPersonName,String EnterContactNumber,String RatesFor,String FromTime,String ToTime,String EnterFacilityNameToSearch,String AddedFacilityName) throws InterruptedException, IOException{
	helper.ClickByID(VariableCalling.ClickOnAddButton);
	helper.DeepSleep();
	Method5.AddFreeFacility(EnterFacilityName, EnterContactPersonName, EnterContactNumber, RatesFor, FromTime, ToTime, EnterFacilityNameToSearch, AddedFacilityName);	
	Reporter.log(" ", true);
	...
	Reporter.log("---------------------------", true);	
	Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"AddedFacilityWithNotAllowedBooking" , true);
	Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"EditFacilityNoAllowedBooking" , true);
	Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"DeletedPaidFacilityWithNoAllowedBooking" , true);
