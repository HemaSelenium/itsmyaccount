...
public class BookOTHFacilityWithSameTimingOverlap extends TestBase{
@Test(priority=1,dataProvider="OTHFacilitySimulationOfSameTimingOverLapWithAdminLogin",dataProviderClass= DataProvider6.class)
...
Reporter.log("ScriptName:Admin Login - Book for 12:01 AM to 2:00 PM - Same timing Overlap", true);	
Reporter.log("----------------------------------------------------------------------------", true);
Reporter.log(" ", true);
		...
		helper.MaxSleep();
		helper.TakeScreenShotOfWindowPopUp("Popup Came After Booking OTHFacility of Same Timing OverLap  with  Admin Login");
		helper.DeepSleep();
		try{
		helper.ProcessAlert();
		helper.Sleep();
		...
		Reporter.log("---------------------------", true);	
		Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"Popup Came After Booking OTHFacility of Same Timing OverLap  with  Admin Login",true);
		Reporter.log(" ", true);
