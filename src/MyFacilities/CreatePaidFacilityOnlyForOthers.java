...
public class CreatePaidFacilityOnlyForOthers extends TestBase{
@Test(priority=1,dataProvider="PaidFacilityOnlyForOthers",dataProviderClass= DataProvider4.class)
...
Reporter.log("Script Name:Admin---->Application--->MyFacilities--->Create one facility with PAID - Allowed for Booking - 1 hour Rs 3000 (Only for Others and link Owner Parent Facility) + Cancel Chrgs - Rs. 0", true);	
Reporter.log("----------------------------------------------", true);	
Reporter.log(" ", true);
...
helper.DeepSleep();
Method6.AddFacilityForOthers(EnterFacilityName, LinkParentFacility, EnterContactPersonName, EnterContactNumber, RatesFor, FromTime, ToTime, EnterMinimumHours, EnterAmountForMinimumHours, EnterCancelCharges, EnterFacilityNameToSearch, AddedFacilityName);

}
@Test(priority=2,dataProvider="EditPaidFacilityOnlyForOthers",dataProviderClass= DataProvider4.class)
...
try{
	...
	helper.TakeScreenShot("EditPaidFacilityOnlyForOthers");
	...
	try{
		...
		helper.TakeScreenShot("DeletedPaidFacilityOnlyForOthers");
	}
...
@Test(priority=3,dataProvider="PaidFacilityOnlyForOthers",dataProviderClass= DataProvider4.class)
public void AddFacilityAfterDelete(String EnterFacilityName,String LinkParentFacility,String EnterContactPersonName,String EnterContactNumber,String RatesFor,String FromTime,String ToTime,String EnterMinimumHours,String EnterAmountForMinimumHours,String EnterCancelCharges,String EnterFacilityNameToSearch,String AddedFacilityName) throws InterruptedException, IOException{
	...
	Reporter.log("---------------------------", true);	
	Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"PaidFacilityOnlyForOthers" , true);
	Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"EditPaidFacilityOnlyForOthers" , true);
	Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"DeletedPaidFacilityOnlyForOthers" , true);
