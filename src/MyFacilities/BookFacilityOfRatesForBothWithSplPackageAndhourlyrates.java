...
public class BookFacilityOfRatesForBothWithSplPackageAndhourlyrates extends TestBase{
	@Test(priority=1,dataProvider="BookFacilityWithSpecialPackageAndHourlyRatesWithAdminLoginFor7hrs",dataProviderClass= DataProvider6.class)
	...
	Reporter.log("ScriptName: Facilityof RatesForBOTH BOOK - Admin Login  - Book for 7 hours (9 AM to 4 PM) - Should show Rs.5000 + 3000 = 8000 (Spl Package + hourly rate)", true);	
	Reporter.log("----------------------------------------------------------------------------", true);
	Reporter.log(" ", true);
	...
	helper.MaxSleep();
	helper.TakeScreenShotOfWindowPopUp("Book Facility Of Rates For Both For 7hrs");
	helper.DeepSleep();
	...
	helper.DeepSleep();
		...
		Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"Booking Not Allowed For BOTH Facility With Admin Login", true);
		}}catch(NoSuchElementException Exception){
		...
		Reporter.log("---------------------------", true);
		Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"Book Facility Of Rates For Both For 7hrs" , true);
		Reporter.log(" ", true);
		Reporter.log("Items ToBechecked Manually", true);	
		Reporter.log("---------------------------", true);
