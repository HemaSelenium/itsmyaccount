...
public class BookFreeFacilityWith30MintsWithMemberLogin extends TestBase{
	@Test(priority=1,dataProvider="BookFree30MintsWithMemberLogin",dataProviderClass= DataProvider4.class)
	...
	Reporter.log("ScriptName:MemberLogin ---->Application--->Book for 30 min (Eg: 9:40 AM to 10:10 AM)", true);	
	Reporter.log("----------------------------------------------------------------------------", true);
	Reporter.log(" ", true);
	...
	helper.TakeScreenShot("Search For FacilityWithFreeAnd Allow For Booking With MemberLogin");}
	try{
	...
	helper.DeepSleep();
	helper.TakeScreenShotOfWindowPopUp("PopupCameAfter saving details of Booking of Free Facility  For 30 mints slot With MemberLogin");
	helper.ProcessAlert();
	helper.Sleep();
	}}			
	...
	Reporter.log("---------------------------", true);	
	Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"Search For FacilityWithFreeAnd Allow For Booking With MemberLogin" , true);
	Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"PopupCameAfter saving details of Booking of Free Facility  For 30 mints slot With MemberLogin",true);
	Reporter.log(" ", true);
