...
public class SimulationFacilityofFullAndHalfDayPricesFor13hrsWithAdminLogin extends TestBase{
	@Test(priority=1,dataProvider="SimulateFacilityWithHalfAndFullDayPricesfor13hrsWithAdminLogin",dataProviderClass= DataProvider7.class)
	...
	Reporter.log("ScriptName:Admin Login  - Book for 13 hours  (9 AM to 10 PM) - Should show Rs. 500+100 = 600", true);	
	Reporter.log("----------------------------------------------------------------------------", true);
	Reporter.log(" ", true);
	...
	Reporter.log("Added  Facility Found Sucessfully", true);
	}
	try{
	...
	helper.TakeScreenShot("Simulation Of Facility With half And Full day Prices For 13hrs With Admin Login");
	helper.DeepSleep();
	}}			
	...
	String PriceDetailsButton=FacilityColoumns.get(12).findElement(By.tagName("a")).getText();
	Reporter.log("Preice Details Button Is Exists With Name Of:" +PriceDetailsButton, true);
	helper.TakeScreenShot("Booking Not Allowed For Facility With half And Full day Prices For 13hrs With Admin Login");
	Reporter.log("Booking Not Allowed For Facility With half And Full day Prices For 13hrs With Admin Login", true);
	}}catch(NoSuchElementException Exception){
	...
	Reporter.log("---------------------------", true);	
	Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"Simulation Of Facility With half And Full day Prices For 13hrs With Admin Login",true);
	Reporter.log(" ", true);
