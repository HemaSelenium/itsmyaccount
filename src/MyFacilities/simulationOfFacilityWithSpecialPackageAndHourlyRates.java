...
public class simulationOfFacilityWithSpecialPackageAndHourlyRates extends TestBase{
	@Test(priority=1,dataProvider="SimulateFacilityWithSpecialPackageAndHourlyRatesWithAdminLogin",dataProviderClass= DataProvider6.class)
	...
	Reporter.log("ScriptName:Simulate Facilityof RatesForBOTH Admin Login  - Book for 6 hours (9 AM to 3 PM) - Should show Rs.5000 + 1500 = 6500 (Spl Package + hourly rate)", true);	
	Reporter.log("----------------------------------------------------------------------------", true);
	Reporter.log(" ", true);
