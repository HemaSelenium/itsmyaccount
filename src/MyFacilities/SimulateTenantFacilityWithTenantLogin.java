...
public class SimulateTenantFacilityWithTenantLogin extends TestBase{
	@Test(priority=1,dataProvider="TenantFacilitySimulationWithTenantLogin",dataProviderClass= DataProvider5.class)
	...
	Reporter.log("ScriptName:Simulate with Member Login (Tenant) - Book for 1:30 hour (12:01 to 1:30 PM) - Charge should be 4000", true);	
	Reporter.log("----------------------------------------------------------------------------", true);
	Reporter.log(" ", true);
	...
	helper.TakeScreenShot("Simulation Of TenantFacility with Tenant Login");
	helper.DeepSleep();
	}}			
	...
	Reporter.log("---------------------------", true);	
	Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"Simulation Of TenantFacility with Tenant Login",true);
	Reporter.log(" ", true);
