...
public class ExpectedVisitorwithoutBlockandApartment extends TestBase1 {
	String VisitorName;
	...
	public void addWithoutBlockAndapartment(String Visitorname, String contactperson, String contactnum,String date,String Fromtime, String Totime,String Purpose ) throws AWTException, InterruptedException{
		Reporter.log("Test Script:  VisitorregisterTestingIMA_TC_006",true);
		Reporter.log("--------------------------------------",true);
		Reporter.log("Script Name: ExpectedVisitorwithoutBlockandApartment",true);
