...
public class FrequentVisitorWithoutSMStick extends TestBase1 {
	public String VisitorName;
	public String VisitorName1;
	@Test(priority =1)
	public void frequent() throws BiffException, IOException, InterruptedException{
		Reporter.log("Test Script:  VisitorregisterTestingIMA_TC_010",true);
		Reporter.log("--------------------------------------",true);
		Reporter.log("Script Name: FrequentVisitorWithoutSMStick",true);
...
if(SeleniumHelper1.driver.findElement(By.xpath(Variables.FrequentVisitorradioButton)).isSelected()){
	...
	@Test(priority=9,dataProvider="register",dependsOnMethods="exit1")
	...
	@Test(priority =13,dataProvider="register1",dependsOnMethods="Manual6")
