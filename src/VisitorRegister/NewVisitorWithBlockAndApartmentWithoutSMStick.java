...
public class NewVisitorWithBlockAndApartmentWithoutSMStick extends TestBase1 {
	...
	public void login(String name,String number, String Contactname, String gate, String purpose, String passnumber) throws AWTException, InterruptedException{
		Reporter.log("Test Script:  VisitorregisterTestingIMA_TC_003",true);
		Reporter.log("--------------------------------------",true);
		Reporter.log("Script Name:  NewVisitorWithBlockAndApartmentWithoutSMStick",true);
		PassNo=passnumber;
