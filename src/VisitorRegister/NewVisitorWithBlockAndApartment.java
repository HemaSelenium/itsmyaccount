...
public class NewVisitorWithBlockAndApartment extends TestBase1{
	...
	public void login(String name,String number, String Contactname, String gate, String purpose, String passnumber) throws AWTException, InterruptedException{
		Reporter.log("Test Script:  VisitorregisterTestingIMA_TC_001",true);
		Reporter.log("--------------------------------------",true);
		Reporter.log("Script Name:  NewVisitorWithBlockAndApartment",true);
	...
	public Object[][] readexcel2() throws IOException, BiffException {
		...
		for (int i = 2; i < rows; i++) {
			for (int j =6 ; j < columns; j++) {
				...
				System.out.println(inputdata[i - 2][j-6]);
			}
		}
		return inputdata;
	}
