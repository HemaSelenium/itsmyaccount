...
public class SearchAndExportInAdminLogin extends TestBase1 {
	@Test
	public void FromAndToDate() throws InterruptedException, IOException, HeadlessException, AWTException{
		Reporter.log("Test Script:  VisitorregisterTestingIMA_TC_013",true);
		Reporter.log("--------------------------------------",true);
		Reporter.log("Script Name: SearchAndExportInAdminLogin",true);
		...
		ImageIO.write(image, "png", new File("C:\\Users\\IMA\\workspace\\ItsMyAccount\\Visitor.png"));
		helper1.SAP();
Reporter.log("Export pdf file of visitor register stored in path:C:\\Users\\IMA\\workspace\\ItsMyAccount\\Visitor.png",true);
	      helper1.SAP();
