...
public class ExpectedVisitorByMemberWithoutSMStick extends TestBase1 {
	String VisitorName;
	String choose="yes";
	...
	public void create(String Visitorname, String contactperson, String contactnum,String date,String Fromtime, String Totime,String Purpose) throws InterruptedException{
		Reporter.log("Test Script:  VisitorregisterTestingIMA_TC_012",true);
		Reporter.log("--------------------------------------",true);
		Reporter.log("Script Name: ExpectedVisitorByMemberWithoutSMStick",true);
