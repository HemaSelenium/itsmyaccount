...
public class CreateComplaintByNonMember extends TestBase{
	...
	@Test(priority=3,dataProvider="EditComplaintByNonMember",dataProviderClass= DataProvider3.class,dependsOnMethods={"AddComplaints"})
	...
	Reporter.log("---------------------------", true);	
	Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"AddedCompalintByNonMemberLogin" +  "    AddedCompalint", true);	
	Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"Edited Complaint By NonMemberLogin" +  "    Edited Complaint By NonMemberLogin", true);	
	Reporter.log("File Name : "+GlobalVariablesCalling.ScreenShotsFileName+"List Of Complaints After Delete Added Complaint By NonMember" +  "    List Of Complaints After Delete", true);	
	Reporter.log(" ", true);	
		}
